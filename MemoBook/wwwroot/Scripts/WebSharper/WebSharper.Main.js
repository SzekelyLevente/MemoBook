(function(Global)
{
 ...
 DateTime=Pervasives.DateTime=Pervasives.DateTime||{};
 ...
 DateTime.replace=function(str,f)
 {
  return str.replace(new Global.RegExp("(\\w)\\1*","g"),f);
 };
 DateTime.DateFormatter=function(date,f)
 {
  var d;
  function padLeft(minLength,x)
  {
   return x.length<minLength?Strings.replicate(minLength-x.length,"0")+x:x;
  }
  d=new Global.Date(date);
  return DateTime.replace(f,function(m)
  {
   var m$1,m$2,m$3,m$4,hours,m$5,hours$1,m$6,m$7,m$8;
   m$1=Strings.Substring(m,0,1);
   return m$1=="y"?(m$2=m.length,m$2===1?Global.String(d.getFullYear()%10):m$2===2?padLeft(2,Global.String(d.getFullYear()%100)):m$2===3?padLeft(3,Global.String(d.getFullYear()%1000)):m$2===4?padLeft(4,Global.String(d.getFullYear())):m$2===5?padLeft(5,Global.String(d.getFullYear())):m):m$1=="M"?(m$3=m.length,m$3===1?Global.String(d.getMonth()+1):m$3===2?padLeft(2,Global.String(d.getMonth()+1)):m):m$1=="d"?(m$4=m.length,m$4===1?Global.String(d.getMonth()+1):m$4===2?padLeft(2,Global.String(d.getMonth()+1)):m):m$1=="h"?(hours=d.getHours(),(m$5=m.length,m$5===1?Global.String(hours>12?hours%12:hours):m$5===2?padLeft(2,Global.String(hours>12?hours%12:hours)):m)):m$1=="H"?(hours$1=d.getHours(),(m$6=m.length,m$6===1?Global.String(hours$1):m$6===2?padLeft(2,Global.String(hours$1)):m)):m$1=="m"?(m$7=m.length,m$7===1?Global.String(d.getMinutes()):m$7===2?padLeft(2,Global.String(d.getMinutes())):m):m$1=="s"?(m$8=m.length,m$8===1?Global.String(d.getSeconds()):m$8===2?padLeft(2,Global.String(d.getSeconds())):m):m$1=="f"?Global.String(d.getMilliseconds()):m;
  });
 };
